...
const ContactFooter = () => {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 font-libertinus">
      <div
        style={{ backgroundImage: 'linear-gradient(to left, #000000ff, #3b3b3bff)' }}
        className="py-12 rounded-2xl"
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h3 className={`text-3xl  font-bold text-gray-900 mb-4 text-[${textColor}]`}>Let's Connect</h3>
